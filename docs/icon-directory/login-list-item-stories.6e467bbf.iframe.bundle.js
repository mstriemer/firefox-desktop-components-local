...
module.exports = __webpack_require__.p + "login-list-lit-item.ef5cd48542b647e24cf3.css";
      ...
      >
        <div class="labels" slot="login-info">
          ...
          ${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.when)(
            this.username,
            () =>
              (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)` <span class="subtitle" dir="auto">
                ${this.username}
              </span>`,
            () =>
        ...
        <div slot="notificationIcon">
          ${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.choose)(
            this.notificationIcon,
            [
              [
                "breached",
...
/* harmony import */ var _login_list_lit_item_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(70504);
/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
...
const NewLoginListItem = ({ selected }) => {
...
//# sourceMappingURL=login-list-item-stories.6e467bbf.iframe.bundle.js.map