"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[535],{
...
/* harmony export */   tokensTable: () => (/* binding */ tokensTable),
...
/* harmony import */ var _dist_tokens_table_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(73368);
/* harmony import */ var _tokens_table_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(90383);
/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
...
class TablesPage extends chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.LitElement {
  ...
  constructor() {
    super();
    this.surface = "brand";
    this.tokensData = _dist_tokens_table_mjs__WEBPACK_IMPORTED_MODULE_1__.tokensTable;
  }
      ...
      <div class="page-wrapper">
        <div class="filters-wrapper">
          ...
          <div class="table-filter" @click=${this.handleTableFilterClick}>
            ...
            ${Object.keys(_dist_tokens_table_mjs__WEBPACK_IMPORTED_MODULE_1__.tokensTable).map(table => {
...
class TokensTable extends chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.LitElement {
  ...
  getRawValue(theme, token) {
    ...
    if (matches) {
      let variableValue = _dist_tokens_table_mjs__WEBPACK_IMPORTED_MODULE_1__.variableLookupTable[matches.groups?.lookupKey];
  ...
  linkTemplate(_, value, tokenName) {
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`
      <a
        class=${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.classMap)({ "link-preview": true, outline: hasOutline })}
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`
      <td>
        <div class="preview-wrapper">
          ${type == "preview"
            ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`${this.getTemplate(raw ?? value, tokenName)}`
            : (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`<p class="value">${value}</p>
...
//# sourceMappingURL=storybook-tokens-table-stories.7df7ec85.iframe.bundle.js.map