"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[8835],{
...
/* harmony export */ });
/* harmony import */ var toolkit_components_reader_moz_slider_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(54110);
...
class MozSlider extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
  ...
  setupIcon() {
    if (this.sliderIcon) {
      return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<div class="icon-container">
  ...
  ticksTemplate() {
    if (this.ticks > 0) {
      ...
      for (let i = 0; i < this.ticks; i++) {
        ...
        tickList.push(
          (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<option
            id=${optionId}
...
module.exports = __webpack_require__.p + "moz-slider.ad743e6266d3c8d03064.css";
...
/* harmony export */ });
/* harmony import */ var _content_widgets_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9151);
/* harmony import */ var chrome_global_content_reader_moz_slider_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(26661);
/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
...
const Template = ({ min, max, value, ticks, labelL10nId, sliderIcon }) => (0,_content_widgets_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`
  <moz-slider
    min=${min}
    max=${max}
    value=${value}
...
//# sourceMappingURL=moz-slider-stories.59405060.iframe.bundle.js.map