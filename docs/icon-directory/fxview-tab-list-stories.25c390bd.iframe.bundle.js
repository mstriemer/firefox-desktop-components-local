"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[30,2017,3709],{
...
/* harmony import */ var browser_components_firefoxview_fxview_tab_list_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(78780);
var _templateObject;
...
/* harmony import */ var _search_helpers_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9268);
/* harmony import */ var chrome_global_content_elements_moz_button_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(93709);
...
class FxviewTabListBase extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_3__.MozLitElement {
  ...
  render() {
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)`
      ...
      >
        ${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.when)(
          ...
          `,
          () =>
            (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)`${this.tabItems.map((tabItem, i) =>
...
class FxviewTabRowBase extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_3__.MozLitElement {
  ...
  highlightSearchMatches(query, string) {
    ...
    while ((result = regex.exec(string)) !== null) {
      ...
      fragments.push(
        (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)`<strong>${string.substring(indexStart, indexEnd)}</strong>`
      );
  ...
  secondaryButtonTemplate() {
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)`${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.when)(
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)`
      ...
      >
        ...
        ${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.when)(
          !this.compact,
          () =>
            (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)`${this.urlTemplate()} ${this.dateTemplate()}
            ${this.timeTemplate()}`
        )}
      </a>
...
class VirtualList extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_3__.MozLitElement {
  ...
  render() {
    if (this.isAlwaysVisible || this.isVisible) {
      return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)`
        ${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.repeat)(
          this.renderItems,
          (data, i) => i,
...
module.exports = __webpack_require__.p + "fxview-tab-row.bc19965d726ada185806.css";
...
//# sourceMappingURL=fxview-tab-list-stories.25c390bd.iframe.bundle.js.map