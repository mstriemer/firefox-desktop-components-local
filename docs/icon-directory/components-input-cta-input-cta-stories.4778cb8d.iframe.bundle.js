"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[30,3011,3709],{
...
class InputCta extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
  ...
  render() {
    const panelListTemplate = this.action
      ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<panel-list id=${this._menuId}>
          ${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.repeat)(
            InputCta.ACTIONS,
            key => key,
            key =>
              (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<panel-item
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      ...
      >
        <slot>
          ${this.action &&
          (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<span data-l10n-id=${this.actionLabelId}></span>`}
        </slot>
      </moz-button>
      ${panelListTemplate}
    `;
...
/* harmony import */ var chrome_browser_content_aiwindow_components_input_cta_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(32485);
/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
...
const Template = ({ action }) => (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`
...
//# sourceMappingURL=components-input-cta-input-cta-stories.4778cb8d.iframe.bundle.js.map