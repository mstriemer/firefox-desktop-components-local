"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[151],{
...
/* harmony import */ var _aboutlogins_content_components_login_command_button_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(82812);
var _templateObject;
...
/* harmony export */ });
/* harmony import */ var browser_components_aboutlogins_content_components_login_command_button_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(60583);
...
const stylesTemplate = () =>
  (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)`<link
      rel="stylesheet"
...
const LoginCommandButton = ({
  ...
  (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)`<button
    class=${variant}
...
class DeleteButton extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_3__.MozLitElement {
  ...
  render() {
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)` ${stylesTemplate()}
    ${LoginCommandButton({
...
class CopyUsernameButton extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_3__.MozLitElement {
  ...
  render() {
    ...
    ${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.when)(
      this.copiedText,
      () =>
        (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)`${LoginCommandButton({
...
//# sourceMappingURL=login-command-button-stories.1cbdf686.iframe.bundle.js.map