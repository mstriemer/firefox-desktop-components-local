...
/* harmony import */ var _aboutlogins_content_components_login_timeline_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(95265);
var _templateObject;
...
class Timeline extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
  ...
  render() {
    ...
    let points = this.history.map((entry, index) => {
      ...
      let styles = (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.styleMap)({ gridColumn: columnNumber });
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      ...
      />
      <div
        class="timeline ${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.classMap)({ empty: !this.history.length })}"
        style=${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.styleMap)({ gridTemplateColumns: columns })}
      >
        <div class="line"></div>
        <div class="line"></div>
        <div class="line"></div>
...
//# sourceMappingURL=login-timeline-stories.bb3e1080.iframe.bundle.js.map