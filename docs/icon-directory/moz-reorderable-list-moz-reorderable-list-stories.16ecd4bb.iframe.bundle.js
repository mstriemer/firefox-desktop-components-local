"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[6005,7238],{
...
/* harmony import */ var _moz_reorderable_list_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(96005);
  ...
  render() {
    ...
    return (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`
      ...
      >
        <ul>
          ${this.items.map(
            item => (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)` <li>${this.contentTemplate(item)}</li> `
          )}
        </ul>
      </moz-reorderable-list>
...
const Template = ({ demoType }) => (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`
...
//# sourceMappingURL=moz-reorderable-list-moz-reorderable-list-stories.16ecd4bb.iframe.bundle.js.map