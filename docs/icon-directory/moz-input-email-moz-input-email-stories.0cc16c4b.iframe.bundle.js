"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[114,8141,8521],{
...
/* harmony export */   "default": () => (/* binding */ MozInputEmail)
/* harmony export */ });
/* harmony import */ var chrome_global_content_elements_moz_input_text_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(88141);
...
/**
 * An email input custom element.
 *
 * @tagname moz-input-email
 ...
 */
class MozInputEmail extends chrome_global_content_elements_moz_input_text_mjs__WEBPACK_IMPORTED_MODULE_0__["default"] {
  inputTemplate() {
    return super.inputTemplate({ type: "email" });
  }
}
customElements.define("moz-input-email", MozInputEmail);
...
/* harmony import */ var _moz_input_email_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(38521);
/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  title: "UI Widgets/Input Email",
  component: "moz-input-email",
  argTypes: {
    l10nId: {
      options: [
        "moz-input-email-label",
        "moz-input-email-placeholder",
        "moz-input-email-description",
        "moz-input-email-label-wrapped",
      ],
      control: { type: "select" },
    },
  },
...
moz-input-email-description =
  .label = Email:
  .description = Description for the email input
  .placeholder = Placeholder text
moz-input-email-label-wrapped =
...
const Template = ({
  ...
  <moz-input-email
    ...
    class=${(0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.classMap)({ "text-truncated-ellipsis": ellipsized })}
  >
    ${hasSlottedDescription
      ? (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`<div slot="description">${description}</div>`
      : ""}
    ${hasSlottedSupportLink
...
Default.args = {
  name: "example-moz-input-email",
  value: "",
  iconSrc: "",
  disabled: false,
  l10nId: "moz-input-email-label",
  supportPage: "",
  accessKey: "",
...
WithPlaceholder.args = {
  ...Default.args,
  l10nId: "moz-input-email-placeholder",
};
...
withDescription.args = {
  ...Default.args,
  l10nId: "moz-input-email-description",
};
...
WithEllipsizedLabel.args = {
  ...Default.args,
  ellipsized: true,
  l10nId: "moz-input-email-label-wrapped",
};
...
//# sourceMappingURL=moz-input-email-moz-input-email-stories.0cc16c4b.iframe.bundle.js.map