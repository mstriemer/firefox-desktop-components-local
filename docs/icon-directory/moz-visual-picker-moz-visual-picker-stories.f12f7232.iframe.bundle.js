"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[7362,7537,8385,8552],{
...
/* harmony export */ });
/* harmony import */ var _vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9151);
/* harmony import */ var _moz_visual_picker_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(47537);
/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
  ...
  return (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`
    ...
    >
      ${[...Array.from({ length: 3 })].map(
        (_, i) =>
          (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`<moz-visual-picker-item
            value=${i + 1}
            class=${(0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.classMap)({ "avatar-item": slottedItem == "avatar" })}
            data-l10n-id=${slottedItem == "avatar"
              ? AVATAR_L10N_IDS[i]
              : _vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.nothing}
...
/* harmony import */ var _lit_select_control_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(38552);
/* harmony import */ var _lit_utils_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(21743);
...
class MozVisualPickerItem extends (0,_lit_select_control_mjs__WEBPACK_IMPORTED_MODULE_2__.SelectControlItemMixin)(_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_3__.MozLitElement) {
  ...
  contentTemplate() {
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      ${this.imageSrc
        ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<img src=${this.imageSrc} role="presentation" part="image" />`
      ...
      <div class="text-content">
        ...
        ${this.description
          ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<p class="description">${this.description}</p>`
          : chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.nothing}
      </div>
    `;
  }
...
//# sourceMappingURL=moz-visual-picker-moz-visual-picker-stories.f12f7232.iframe.bundle.js.map