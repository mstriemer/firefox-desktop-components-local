"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[4178,6949,8141],{
...
/* harmony import */ var _moz_input_url_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(26949);
/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  title: "UI Widgets/Input Url",
  component: "moz-input-url",
  argTypes: {
    l10nId: {
      options: [
        "moz-input-url-label",
        "moz-input-url-placeholder",
        "moz-input-url-description",
        "moz-input-url-label-wrapped",
      ],
      control: { type: "select" },
    },
  },
...
moz-input-url-description =
  .label = URL:
  .description = Description for the URL input
  .placeholder = Placeholder text
moz-input-url-label-wrapped =
...
Default.args = {
  name: "example-moz-input-url",
  value: "",
  iconSrc: "",
  disabled: false,
  l10nId: "moz-input-url-label",
  supportPage: "",
  accessKey: "",
...
WithPlaceholder.args = {
  ...Default.args,
  l10nId: "moz-input-url-placeholder",
};
...
withDescription.args = {
  ...Default.args,
  l10nId: "moz-input-url-description",
};
...
WithEllipsizedLabel.args = {
  ...Default.args,
  ellipsized: true,
  l10nId: "moz-input-url-label-wrapped",
};
...
//# sourceMappingURL=moz-input-url-moz-input-url-stories.b6777d6b.iframe.bundle.js.map