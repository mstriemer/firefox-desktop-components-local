"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[1093,1547,5296,7010],{
...
/* harmony import */ var chrome_global_content_elements_panel_list_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(47010);
/* harmony import */ var browser_components_migration_content_migration_wizard_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(74850);
/* harmony import */ var chrome_browser_content_migration_migration_wizard_constants_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(21506);
/* harmony import */ var toolkit_widgets_named_deck_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(75296);
...
/* harmony import */ var chrome_global_content_elements_moz_button_group_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1093);
/* harmony import */ var chrome_browser_content_migration_migration_wizard_constants_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(21506);
...
class MigrationWizard extends HTMLElement {
  ...
  setState(state) {
    ...
    this.#deck.toggleAttribute(
      "aria-busy",
      state.page == chrome_browser_content_migration_migration_wizard_constants_mjs__WEBPACK_IMPORTED_MODULE_2__.MigrationWizardConstants.PAGES.LOADING
    );
  ...
  #onBrowserProfileSelectionChanged(panelItem) {
    ...
    let showNoPermissionsMessage =
      panelItem.getAttribute("type") ==
        chrome_browser_content_migration_migration_wizard_constants_mjs__WEBPACK_IMPORTED_MODULE_2__.MigrationWizardConstants.MIGRATOR_TYPES.BROWSER &&
    ...
    for (let group of resourceGroups) {
      ...
      switch (progressValue) {
        ...
        case chrome_browser_content_migration_migration_wizard_constants_mjs__WEBPACK_IMPORTED_MODULE_2__.MigrationWizardConstants.PROGRESS_VALUE.SUCCESS: {
          ...
          if (
            resourceType ==
            chrome_browser_content_migration_migration_wizard_constants_mjs__WEBPACK_IMPORTED_MODULE_2__.MigrationWizardConstants.DISPLAYED_RESOURCE_TYPES.EXTENSIONS
          ) {
            messageText.textContent = "";
  ...
  async #displaySelectedResources() {
    ...
    let resourceTypeToLabelIDs = {
      [chrome_browser_content_migration_migration_wizard_constants_mjs__WEBPACK_IMPORTED_MODULE_2__.MigrationWizardConstants.DISPLAYED_RESOURCE_TYPES.BOOKMARKS]:
        "migration-list-bookmark-label",
      [chrome_browser_content_migration_migration_wizard_constants_mjs__WEBPACK_IMPORTED_MODULE_2__.MigrationWizardConstants.DISPLAYED_RESOURCE_TYPES.PASSWORDS]:
        "migration-list-password-label",
      [chrome_browser_content_migration_migration_wizard_constants_mjs__WEBPACK_IMPORTED_MODULE_2__.MigrationWizardConstants.DISPLAYED_RESOURCE_TYPES.HISTORY]:
        "migration-list-history-label",
      [chrome_browser_content_migration_migration_wizard_constants_mjs__WEBPACK_IMPORTED_MODULE_2__.MigrationWizardConstants.DISPLAYED_RESOURCE_TYPES.EXTENSIONS]:
        "migration-list-extensions-label",
      [chrome_browser_content_migration_migration_wizard_constants_mjs__WEBPACK_IMPORTED_MODULE_2__.MigrationWizardConstants.DISPLAYED_RESOURCE_TYPES.FORMDATA]:
        "migration-list-autofill-label",
      [chrome_browser_content_migration_migration_wizard_constants_mjs__WEBPACK_IMPORTED_MODULE_2__.MigrationWizardConstants.DISPLAYED_RESOURCE_TYPES.PAYMENT_METHODS]:
  ...
  #handleClickEvent(event) {
    if (
      ...
      if (
        ...
        chrome_browser_content_migration_migration_wizard_constants_mjs__WEBPACK_IMPORTED_MODULE_2__.MigrationWizardConstants.MIGRATOR_TYPES.FILE
      ) {
        this.#doImport();
      }
      ...
      let checkbox = this.#shadowRoot.querySelector(
        `label[data-resource-type="${chrome_browser_content_migration_migration_wizard_constants_mjs__WEBPACK_IMPORTED_MODULE_2__.MigrationWizardConstants.DISPLAYED_RESOURCE_TYPES.PASSWORDS}"]`
      ).control;
...
//# sourceMappingURL=migration-wizard-stories.e9aa91aa.iframe.bundle.js.map