"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[6345,6494],{

/***/ 44494:
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "moz-select.ad6289e0ac3665159861.css";
  ...
  selectTemplate() {
    ...
    >
      ${this.options.map(option =>
        option.separator
          ? (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<hr />`
  ...
  panelListTemplate() {
    ...
    >
      ${this.options.map(option =>
        option.separator
          ? (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<hr />`
          : (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<panel-item
              .value=${option.value}
              ?selected=${option.value == this.value}
              ?disabled=${option.disabled}
              ?hidden=${option.hidden}
...
/* harmony export */   WithSeparator: () => (/* binding */ WithSeparator),
...
/* harmony import */ var _moz_select_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(66345);
/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
...
const Template = ({
  ...
  <div style="width:300px">
    ...
    >
      ...
      ${options.map(
        (opt, i) =>
          (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`${i == 2 && withSeparator ? (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`<hr />` : ""}
            <moz-option
              value=${opt.value}
...
const WithSeparator = Template.bind({});
WithSeparator.args = {
  ...Default.args,
  withSeparator: true,
};
...
//# sourceMappingURL=moz-select-moz-select-stories.33a37671.iframe.bundle.js.map