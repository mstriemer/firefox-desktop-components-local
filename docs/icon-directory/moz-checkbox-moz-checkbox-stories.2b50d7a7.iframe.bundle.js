"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[30,4237,6115,9040],{
...
/* harmony import */ var _moz_checkbox_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(86115);
...
const Template = ({
  ...
  let checkboxTemplate = (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`
    ...
    >
      ${hasSlottedDescription
        ? (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`<div slot="description">test slot text</div>`
        : ""}
      ${hasSlottedSupportLink
        ? (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`<a slot="support-link" href="www.example.com">Click me!</a>`
        : ""}
      ${nestedFields
        ? (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`<moz-checkbox slot="nested" data-l10n-id=${(0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.ifDefined)(l10nId)}>
            </moz-checkbox>
  ...
  `;
  return nestedFields
    ? (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`<moz-fieldset label="Checkbox with nested fields">
        ${checkboxTemplate}
      </moz-fieldset>`
    : checkboxTemplate;
};
...
//# sourceMappingURL=moz-checkbox-moz-checkbox-stories.2b50d7a7.iframe.bundle.js.map