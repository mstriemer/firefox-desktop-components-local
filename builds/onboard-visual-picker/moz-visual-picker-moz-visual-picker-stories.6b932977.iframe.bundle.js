...
/* harmony export */   SmartWindowOnboarding: () => (/* binding */ SmartWindowOnboarding),
...
const SmartWindowOnboarding = () => (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`
  <style>
    :host {
      background-color: var(--color-violet-0) !important;
    }
  </style>
  <moz-visual-picker>
    <moz-visual-picker-item
      variant="smartwindow"
      imagesrc="chrome://browser/content/aiwindow/assets/model-choice-1.svg"
      label="Fastest"
      description="Best for quick answers to everyday questions"
      value="fastest"
    ></moz-visual-picker-item>
    <moz-visual-picker-item
      variant="smartwindow"
      imagesrc="chrome://browser/content/aiwindow/assets/model-choice-2.svg"
      label="All-purpose"
      description="Best for a variety of quick and complex features"
      value="allpurpose"
    ></moz-visual-picker-item>
    <moz-visual-picker-item
      variant="smartwindow"
      imagesrc="chrome://browser/content/aiwindow/assets/model-choice-3.svg"
      label="Personalization"
      description="Best for learning with you"
      value="personalization"
    ></moz-visual-picker-item>
  </moz-visual-picker>
`;
SmartWindowOnboarding.args = {};
...
module.exports = __webpack_require__.p + "moz-visual-picker-item.c2485341d1f74e9a6564.css";
...
//# sourceMappingURL=moz-visual-picker-moz-visual-picker-stories.6b932977.iframe.bundle.js.map